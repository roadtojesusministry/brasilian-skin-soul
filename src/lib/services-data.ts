...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    fullDesc: 'ANCIENT BRASILIAN WISDOM · SKIN & SOUL\n\nSignature Ritual of Brasilian SkinSoul\n\nA 90-minute immersive ritual inspired by ancient Brazilian healing traditions — designed to restore radiant skin, release deep tension, and bring the body and spirit back into harmony.\n\nThe ritual begins with a fresh papaya enzyme treatment that gently dissolves dull surface cells, revealing smoother, brighter, naturally luminous skin.\n\nFacial acupressure awakens key energy points while a signature Brasilian lymphatic lifting massage sculpts facial contours, reduces puffiness, and restores healthy circulation.\n\nReflexology stimulates the body\'s healing pathways through targeted foot pressure points, encouraging full-body balance and deep relaxation.\n\nA cooling jade eye mask de-puffs the delicate eye area, followed by a nourishing bamboo mask that replenishes hydration and glow.\n\nThe ritual concludes with a deeply relaxing scalp massage that melts away stress and restores a sense of calm.\n\nFace, feet, and scalp are treated as one connected system — leaving your skin luminous, your body relaxed, and your energy renewed.\n\nIdeal for:\n• Stress relief and nervous system reset\n• Dull or tired skin\n• Puffiness and fluid retention\n• Clients seeking a deeply relaxing holistic facial',
    badge: 'HOLISTIC',
    iconName: 'Leaf',
